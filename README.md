...
| Engineering | Value |
|---|---|
| Test suite | 849 tests collected (1 environment-dependent skip; the suite itself verifies this number) |
...
- **Tests & coverage:** 849 tests collected, 97.51% coverage against an 85%-floor gate that fails
