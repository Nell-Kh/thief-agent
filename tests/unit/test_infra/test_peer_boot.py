"""Tests for the peer boot and connectivity check, all network mocked.

Split from ``test_http_transport.py`` under the 150-line rule when the
transport grew its persistent-session tests.
"""
