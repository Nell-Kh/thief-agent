...
| Engineering | Value |
|---|---|
| Test suite | 942 tests collected (1 environment-dependent skip; the suite itself verifies this number) |
...
- **Tests & coverage:** 942 tests collected, 97.55% coverage against an 85%-floor gate that fails
