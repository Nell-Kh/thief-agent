...
| Engineering | Value |
|---|---|
| Test suite | 864 tests collected (1 environment-dependent skip; the suite itself verifies this number) |
...
- **Tests & coverage:** 864 tests collected, 97.60% coverage against an 85%-floor gate that fails
