...
| Engineering | Value |
|---|---|
| Test suite | 910 tests collected (1 environment-dependent skip; the suite itself verifies this number) |
...
- **Tests & coverage:** 910 tests collected, 97.61% coverage against an 85%-floor gate that fails
